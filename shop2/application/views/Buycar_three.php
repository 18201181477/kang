    ...
    <div class="content mar_20">
    	...
    	<div class="warning">        	
            <table border="0" style="width:1000px; text-align:center;" cellspacing="0" cellpadding="0">
              <tr height="35">
                <td style="font-size:18px;">
                	感谢您在本店购物！您的订单已提交成功，请记住您的订单号: <font color="#ff4e00"><span style="cursor:pointer" class="span"><?=$this->session->userdata['order']['order_sn']?></span></font>
                </td>
              </tr>
              <tr>
                <td style="font-size:14px; font-family:'宋体'; padding:10px 0 20px 0; border-bottom:1px solid #b6b6b6;">
                	您选定的配送方式为: <font color="#ff4e00">申通快递</font>； &nbsp; &nbsp;您选定的支付方式为: <font color="#ff4e00">银行卡</font>； &nbsp; &nbsp;您的应付款金额为: <font color="#ff4e00">￥<?=$this->session->userdata['order']['order_amount']?></font>
                </td>
              </tr>
              <tr>
                <td style="padding:20px 0 30px 0; font-family:'宋体';">
              ...
              <tr>
                <td>
                	<div class="btn_u" style="margin:0 auto; padding:0 20px; width:120px;"><a class="a" href="javascript:;">立即使用支付宝支付</a></div>
                	<a href="<?=site_url('Index/index')?>">首页</a> &nbsp; &nbsp; <a href="javascript:;">用户中心</a>
                </td>
              </tr>
            </table>        	
        </div>
...
<script type="text/javascript">
  $(".span").click(function(){
    $.ajax({
      ...
      data:{key:'fa6c07f6cee80034c7daa6675f976bbe',com:'zjs',no:'A004091851820'},
      dataType:'jsonp',
      success:function(e)
      {
