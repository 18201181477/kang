    	...
    	<div class="two_bg">
          ...
          <tr height="70">
            ...
            <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
              ...
              <tr height="70">
                <td align="right">
                	<b style="font-size:14px;">应付款金额：<span style="font-size:22px; color:#ff4e00;">￥<span class="sum"></span></span></b>
                </td>
              </tr>
              <tr height="70">
                <td align="right"><a href="<?=site_url('Buycar/index3')?>"><img src="images/btn_sure.gif" /></a></td>
              </tr>
            </table>
