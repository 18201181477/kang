...
<frameset rows="100,*" cols="*" scrolling="No" framespacing="0"
	frameborder="no" border="0"> <frame src="<?=site_url('admin/Index/head')?>"
...
<!-- 引用左边和主体部分 --> <frameset rows="100*" cols="220,*" scrolling="No"
	...
	src="<?=site_url('admin/Index/left')?>" name="leftmenu" id="mainFrame" title="mainFrame">
<frame src="<?=site_url('admin/Index/main')?>" name="main" scrolling="yes" noresize="noresize"
